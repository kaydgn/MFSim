...
| FEAD (kayış-kasnak) | `fead-analysis` | `fead-analysis` | `js/cp-fead.js` | **YOK — kasnaklar bağlanmaz.** Kayış sırası **Kayış Tablosu**'nun satır sırası (`node.data.beltIndex`) |
