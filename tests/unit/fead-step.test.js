...
// ── Yardımcı: 2B FEAD düzenini 3B montaja yerleştir ─────────────────────
...
describe('uçtan uca: STEP → örnek kaydı → köprü → Gates AG00686', () => {
  ...
  function kur() {
    ...
    Object.assign(ten.data, { preload: 8.59, kArm: 0.482, meanLoad: 24.5442, loadStopRelDeg: 62.4 });
  ...
  test('kayıt örnek biçiminde; koordinat, çap, kol ve parça kodu birebir', () => {
    ...
    expect(t.cenX).toBeCloseTo(AG.ten.x, 9);
    expect(t.cenY).toBeCloseTo(AG.ten.y, 9);
