...
function _mf2048InjectCSS() {
  ...
  st.textContent = [
    ...
    '.mf2048-title{font-size:var(--fs-h1);font-weight:800;letter-spacing:.5px;color:var(--text-heading,#e2e8f0);margin:0;line-height:1;}',
    '.mf2048-sub{font-size:var(--fs-body);letter-spacing:2px;text-transform:uppercase;color:var(--text-secondary,#7a8599);margin:3px 0 0;}',
    ...
    '.mf2048-score span{display:block;font-size:var(--fs-tiny);letter-spacing:1.5px;text-transform:uppercase;color:var(--text-muted,#4a5568);}',
    '.mf2048-score b{font-size:var(--fs-title);font-weight:700;color:var(--text-primary,#c8d1dc);}',
    ...
    '.mf2048-hint{font-size:var(--fs-body);color:var(--text-secondary,#7a8599);line-height:1.5;}',
