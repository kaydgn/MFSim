...
function _mf2048InjectCSS() {
  ...
  st.textContent = [
    ...
    '.mf2048-hint kbd{font-family:inherit;font-size:var(--fs-body);padding:1px 6px;border-radius:5px;',
      'background:var(--bg-tertiary,#151a22);border:1px solid var(--border-light,#222b3a);color:var(--text-primary,#c8d1dc);}',
    // Düğmeler
    '.mf2048-btn{cursor:pointer;padding:9px 16px;border-radius:9px;font-size:var(--fs-lg);font-weight:600;',
