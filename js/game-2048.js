...
function _mf2048InjectCSS() {
  ...
  st.textContent = [
    ...
    '.mf2048-title{font-size:var(--fs-h1);font-weight:800;letter-spacing:.5px;color:var(--text-heading);margin:0;line-height:1;}',
    '.mf2048-sub{font-size:var(--fs-body);letter-spacing:2px;text-transform:uppercase;color:var(--text-secondary);margin:3px 0 0;}',
    '.mf2048-scores{display:flex;gap:8px;margin-left:auto;}',
    '.mf2048-score{min-width:62px;text-align:center;padding:6px 12px;border-radius:var(--radius-lg);',
      'background:var(--bg-tertiary);border:1px solid var(--border-light);}',
    '.mf2048-score span{display:block;font-size:var(--fs-tiny);letter-spacing:1.5px;text-transform:uppercase;color:var(--text-muted);}',
    '.mf2048-score b{font-size:var(--fs-title);font-weight:700;color:var(--text-primary);}',
    ...
    '.mf2048-msg-text{font-size:var(--fs-h1);font-weight:800;color:#5c5348;letter-spacing:.5px;}',
    ...
    '.mf2048-hint{font-size:var(--fs-body);color:var(--text-secondary);line-height:1.5;}',
    '.mf2048-hint kbd{font-family:inherit;font-size:var(--fs-body);padding:1px 6px;border-radius:var(--radius-sm);',
      'background:var(--bg-tertiary);border:1px solid var(--border-light);color:var(--text-primary);}',
    // Düğmeler
    '.mf2048-btn{cursor:pointer;padding:9px 16px;border-radius:var(--radius-lg);font-size:var(--fs-lg);font-weight:600;',
      'font-family:inherit;border:1px solid var(--border-light);',
      'background:var(--bg-tertiary);color:var(--text-primary);',
      'transition:background .15s,border-color .15s,transform .1s;}',
    '.mf2048-btn:hover{background:var(--bg-tertiary);border-color:var(--border-hover);}',
    ...
    // Kapat düğmesi
    '.mf2048-close{position:absolute;top:12px;right:12px;width:30px;height:30px;border-radius:var(--radius-md);cursor:pointer;',
      'display:flex;align-items:center;justify-content:center;background:transparent;border:1px solid transparent;',
      'color:var(--text-secondary);transition:background .15s,border-color .15s,color .15s;z-index:2;}',
    '.mf2048-close:hover{background:var(--bg-tertiary);border-color:var(--border-light);color:var(--text-primary);}',
