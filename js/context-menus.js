...
function createNodeContextMenu() {
  ...
  menu.style.cssText = 'display:none; position:fixed; background:var(--bg-secondary); border:1px solid var(--border-color); border-radius:var(--radius-md); box-shadow:var(--shadow-lg); z-index:10001; min-width:200px; padding:4px 0;';
...
function createPortContextMenu() {
  ...
  menu.className = 've-context-menu';
  menu.style.cssText = 'display:none; position:fixed; background:var(--bg-secondary); border:1px solid var(--border-color); border-radius:var(--radius-md); box-shadow:var(--shadow-lg); z-index:10001; min-width:140px; padding:4px 0;';
