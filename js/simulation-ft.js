...
function veFTRunObstacleDynamicSim(obsResult, dynOpts) {
  ...
  // Kalibrasyon: CAN-bus dN/dt ≈ 580 RPM/s, T_net ≈ 280 Nm → J_eff ≈ 4.3 kg·m²
  var J_fluid = opts.J_fluid || 7.0;         // TC sıvı ataleti (kg·m²) — üretici eğrisi + uzman kalibrasyonu (4-4.5s)
  ...
  while(stepCount < maxSteps && !simComplete) {
    ...
    // Yuvarlanma direnci sadece araç hareket halindeyken uygulanır
    // v=0'da lastik yuvarlanmadığından Cr direnci oluşmaz
    var F_yuvarlanma = (v > 1e-6) ? W * Cr : 0;
