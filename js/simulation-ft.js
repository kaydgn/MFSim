...
function veFTRunObstacleDynamicSim(obsResult, dynOpts) {
  ...
  // Kalibrasyon: T_pump×TR modeli ile yeniden kalibre — ön faz ~2.4s hedefi
  var J_fluid = opts.J_fluid || 4.5;         // TC sıvı ataleti (kg·m²) — T_pump×TR modeli ile yeniden kalibre
