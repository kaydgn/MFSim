...
function veFTRunObstacleDynamicSim(obsResult, dynOpts) {
  ...
  // Uzman kalibrasyonu: CAN verisinden engel koşulunda ortalama J_eff ~4-5 kg·m² → J_fluid ≈ 3.5
  var J_fluid = opts.J_fluid || 3.5;         // TC sıvı ataleti (kg·m²) — engel senaryosu kalibrasyonu
