...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if(wasRefreshed) {
    ...
    // Refresh sonrası: durum bilgisini çek, sonra "Program Güncellendi" popup'ını aç
    setTimeout(function() {
      _veCheckAndShowUpdated();
    }, 1500);
  } else {
...
function _veCheckAndShowUpdated() {
  var dot = document.getElementById('ve-deploy-dot');
  var tooltip = document.getElementById('ve-deploy-tooltip');
  if(!dot) return;
