...
//
// Dependencies: importScripts ile fea-primitives, fea-step, fea-tetgen,
// fea-mesh yüklenir. Aynı global API'ı (veFEAMeshFromGeometry) kullanır.
//
// Mesaj formatı:
...
try {
  importScripts('fea-primitives.js', 'fea-step.js', 'fea-tetgen.js', 'fea-mesh.js');
} catch (e) {
