...
function veFEAOpenFullscreenViewer(nodeId) {
  ...
  toolbar.style.cssText = 'flex:0 0 auto; display:flex; align-items:center; justify-content:space-between; padding:10px 16px; background:#1f1f1f; border-bottom:1px solid #444; color:#fff;';
  toolbar.innerHTML =
    '<div style="display:flex; align-items:center; gap:12px;">' +
      '<span style="font-size:0.85rem; font-weight:600;">Yapısal Analiz — 3D Görüntüleyici</span>' +
      '<span style="font-size:0.6rem; color:#aaa;">Sol drag: orbit · Sağ drag: pan · Wheel: zoom</span>' +
    '</div>' +
    '<button id="ve-fea-fullscreen-close" style="background:#ef4444; color:#fff; border:none; padding:6px 14px; font-size:0.7rem; cursor:pointer;">✕ Kapat (Esc)</button>';
  ...
  var viewer = veFEAInitViewer(canvas, { width: w, height: h });
